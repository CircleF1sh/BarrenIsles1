...
public class ItemRegistry {
    ...
    public static final RegistryObject<Item> RAW_DESERT_LIZARD_MEAT = ITEMS.register("raw_desert_lizard_meat",
            () -> new Item(new Item.Properties().group(BarrenIsles.BARREN_GROUP).food(FoodRegistry.RAW_DESERT_LIZARD_MEAT)));

    public static final RegistryObject<Item> COOKED_DESERT_LIZARD_MEAT = ITEMS.register("cooked_desert_lizard_meat",
            () -> new Item(new Item.Properties().group(BarrenIsles.BARREN_GROUP).food(FoodRegistry.RAW_DESERT_LIZARD_MEAT)));

    public static final RegistryObject<CustomSpawnEggItem> DESERT_LIZARD_SPAWN_EGG = ITEMS.register("desert_lizard_spawn_egg",
            () -> new CustomSpawnEggItem(ModEntityType.DESERT_LIZARD, 0xDDC368, 0x3A3A3A, new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<CustomSpawnEggItem> TOXIC_GILA_SPAWN_EGG = ITEMS.register("toxic_gila_spawn_egg",
            () -> new CustomSpawnEggItem(ModEntityType.TOXIC_GILA, 0x94623C, 0xA556FF, new Item.Properties().group(BarrenIsles.BARREN_GROUP)));
    ...
    public static final RegistryObject<BlockItem> DUNESTEEL_ORE = ITEMS.register("dunesteel_ore",
            () -> new BlockItem(BlockRegistry.DUNESTEEL_ORE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> SCORCHSTONE = ITEMS.register("scorchstone",
            () -> new BlockItem(BlockRegistry.SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> POLISHED_SCORCHSTONE = ITEMS.register("polished_scorchstone",
            () -> new BlockItem(BlockRegistry.POLISHED_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> SCORCHSTONE_TILES = ITEMS.register("scorchstone_tiles",
            () -> new BlockItem(BlockRegistry.SCORCHSTONE_TILES.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> SCORCHSTONE_BRICKS = ITEMS.register("scorchstone_bricks",
            () -> new BlockItem(BlockRegistry.SCORCHSTONE_BRICKS.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> LUMINOUS_SCORCHSTONE = ITEMS.register("luminous_scorchstone",
            () -> new BlockItem(BlockRegistry.LUMINOUS_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> RED_SCORCHSTONE = ITEMS.register("red_scorchstone",
            () -> new BlockItem(BlockRegistry.RED_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> POLISHED_RED_SCORCHSTONE = ITEMS.register("polished_red_scorchstone",
            () -> new BlockItem(BlockRegistry.POLISHED_RED_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> RED_SCORCHSTONE_TILES = ITEMS.register("red_scorchstone_tiles",
            () -> new BlockItem(BlockRegistry.RED_SCORCHSTONE_TILES.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> LUMINOUS_RED_SCORCHSTONE = ITEMS.register("luminous_red_scorchstone",
            () -> new BlockItem(BlockRegistry.LUMINOUS_RED_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> BLUE_SCORCHSTONE = ITEMS.register("blue_scorchstone",
            () -> new BlockItem(BlockRegistry.BLUE_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> POLISHED_BLUE_SCORCHSTONE = ITEMS.register("polished_blue_scorchstone",
            () -> new BlockItem(BlockRegistry.POLISHED_BLUE_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> BLUE_SCORCHSTONE_TILES = ITEMS.register("blue_scorchstone_tiles",
            () -> new BlockItem(BlockRegistry.BLUE_SCORCHSTONE_TILES.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> GREEN_SCORCHSTONE = ITEMS.register("green_scorchstone",
            () -> new BlockItem(BlockRegistry.GREEN_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> MOSSY_SCORCHSTONE = ITEMS.register("mossy_scorchstone",
            () -> new BlockItem(BlockRegistry.MOSSY_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> POLISHED_GREEN_SCORCHSTONE = ITEMS.register("polished_green_scorchstone",
            () -> new BlockItem(BlockRegistry.POLISHED_GREEN_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> GREEN_SCORCHSTONE_TILES = ITEMS.register("green_scorchstone_tiles",
            () -> new BlockItem(BlockRegistry.GREEN_SCORCHSTONE_TILES.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> PURPLE_SCORCHSTONE = ITEMS.register("purple_scorchstone",
            () -> new BlockItem(BlockRegistry.PURPLE_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> POLISHED_PURPLE_SCORCHSTONE = ITEMS.register("polished_purple_scorchstone",
            () -> new BlockItem(BlockRegistry.POLISHED_PURPLE_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> PURPLE_SCORCHSTONE_TILES = ITEMS.register("purple_scorchstone_tiles",
            () -> new BlockItem(BlockRegistry.PURPLE_SCORCHSTONE_TILES.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> SCORCHSAND = ITEMS.register("scorchsand",
            () -> new BlockItem(BlockRegistry.SCORCHSAND.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> RED_SCORCHSTONE_BRICKS = ITEMS.register("red_scorchstone_bricks",
            () -> new BlockItem(BlockRegistry.RED_SCORCHSTONE_BRICKS.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> BLUE_SCORCHSTONE_BRICKS = ITEMS.register("blue_scorchstone_bricks",
            () -> new BlockItem(BlockRegistry.BLUE_SCORCHSTONE_BRICKS.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> GREEN_SCORCHSTONE_BRICKS = ITEMS.register("green_scorchstone_bricks",
            () -> new BlockItem(BlockRegistry.GREEN_SCORCHSTONE_BRICKS.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> PURPLE_SCORCHSTONE_BRICKS = ITEMS.register("purple_scorchstone_bricks",
            () -> new BlockItem(BlockRegistry.PURPLE_SCORCHSTONE_BRICKS.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));
    ...
    public static final RegistryObject<BlockItem> POLISHED_PRISMATIC_SCORCHSTONE = ITEMS.register("polished_prismatic_scorchstone",
            () -> new BlockItem(BlockRegistry.POLISHED_PRISMATIC_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> PRISMATIC_SCORCHSTONE = ITEMS.register("prismatic_scorchstone",
            () -> new BlockItem(BlockRegistry.PRISMATIC_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> UMBRAL_SCORCHSTONE = ITEMS.register("umbral_scorchstone",
            () -> new BlockItem(BlockRegistry.UMBRAL_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> BLOOMING_SCORCHSTONE = ITEMS.register("blooming_scorchstone",
            () -> new BlockItem(BlockRegistry.BLOOMING_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> SCORCHSTONE_COAL_ORE = ITEMS.register("scorchstone_coal_ore",
            () -> new BlockItem(BlockRegistry.SCORCHSTONE_COAL_ORE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> POLISHED_UMBRAL_SCORCHSTONE = ITEMS.register("polished_umbral_scorchstone",
            () -> new BlockItem(BlockRegistry.POLISHED_UMBRAL_SCORCHSTONE.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));

    public static final RegistryObject<BlockItem> UMBRAL_SCORCHSAND = ITEMS.register("umbral_scorchsand",
            () -> new BlockItem(BlockRegistry.UMBRAL_SCORCHSAND.get(), new Item.Properties().group(BarrenIsles.BARREN_GROUP)));
